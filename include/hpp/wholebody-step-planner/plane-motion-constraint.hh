...
#ifndef CHPP_GIK_PLANE_MOTION_CONSTRAINT
#define CHPP_GIK_PLANE_MOTION_CONSTRAINT
...
namespace hpp
{
  ...
  {
    /// Time varying plane constraint for a joint defined by a Kite path
    class ChppGikPlaneMotionConstraint : public CjrlGikMotionConstraint
    {
    public:
      /// Constructor
      ...
      /// \param constrainedJoint Joint the plane of which is constrained.
      ...
      /// hpp-gik plane constraint at given time

      /// Return the plane constraint corresponding to a given time
      ...
      /// \sa ChppGikPlaneMotionConstraint::ChppGikPlaneMotionConstraint.
    ...
    private:
      ChppGikPlaneConstraint * planeConstraint_;
      double startTime_;
      double endTime_;
